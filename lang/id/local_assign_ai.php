...
$string['defaultenableai_desc'] = 'Mengontrol ketersediaan AI secara global untuk tugas. Jika dinonaktifkan, AI dijeda untuk semua tugas tanpa mengubah konfigurasi yang tersimpan; saat diaktifkan kembali, setiap tugas berfungsi lagi dengan konfigurasi aslinya.';
...
$string['logrubriccriterionbyid'] = 'cocok berdasarkan id ({$a})';
$string['logrubriccriterionbyname'] = 'cocok berdasarkan nama (id kriteria {$a})';
$string['logrubriccriterionnotmatched'] = 'TIDAK cocok';
$string['logrubricdiagfailed'] = 'Diagnostik pencocokan rubrik tidak dapat dibuat.';
$string['logrubricfailurereason'] = 'alasan: {$a}';
$string['logrubricinvalidjson'] = 'JSON rubrik yang tersimpan tidak valid:';
$string['logrubricjson'] = 'JSON rubrik (respons AI)';
$string['logrubriclevelbyid'] = 'id level {$a}';
$string['logrubriclevelbypoints'] = 'id level {$a} (cocok berdasarkan poin)';
$string['logrubriclevelnotmatched'] = 'level TIDAK cocok';
$string['logrubricmatchfailed'] = 'Pencocokan rubrik: GAGAL ({$a->matched}/{$a->total})';
$string['logrubricmatchok'] = 'Pencocokan rubrik: OK ({$a->matched}/{$a->total})';
$string['logrubricmodelegacy'] = 'Mode pencocokan: lawas (rekaman tanpa id, disimpan oleh versi plugin atau layanan AI yang lebih lama)';
$string['logrubricmodestrict'] = 'Mode pencocokan: ketat (rekaman menyertakan id Moodle)';
$string['logrubricnodefinition'] = 'Tidak ada definisi rubrik yang tersedia untuk pencocokan; hanya JSON tersimpan yang ditampilkan.';
...
$string['privacy:metadata:datacurso_ai'] = 'Data kiriman dikirim ke penyedia AI Datacurso untuk menghasilkan nilai dan umpan balik. Pengidentifikasi dipseudonimkan bila memungkinkan.';
$string['privacy:metadata:datacurso_ai:course_activity'] = 'Konteks kursus dan tugas (nama, deskripsi, dan instruksi).';
$string['privacy:metadata:datacurso_ai:student_name'] = 'Nama lengkap siswa (dipseudonimkan sebelum dikirim bila memungkinkan).';
$string['privacy:metadata:datacurso_ai:submission_files'] = 'Berkas yang dilampirkan pada kiriman.';
$string['privacy:metadata:datacurso_ai:submission_text'] = 'Teks daring dari kiriman.';
$string['privacy:metadata:datacurso_ai:userid'] = 'Pengidentifikasi siswa yang kirimannya dinilai.';
$string['privacy:metadata:local_assign_ai_config'] = 'Menyimpan konfigurasi AI per tugas.';
$string['privacy:metadata:local_assign_ai_config:assignmentid'] = 'Tugas tempat konfigurasi ini berada.';
$string['privacy:metadata:local_assign_ai_config:graderid'] = 'Pengguna yang tercatat sebagai penilai untuk nilai yang diterapkan AI.';
$string['privacy:metadata:local_assign_ai_config:usermodified'] = 'Pengguna yang terakhir mengubah konfigurasi.';
...
$string['privacy:metadata:local_assign_ai_pending:assessment_guide_response'] = 'Umpan balik panduan penilaian yang dihasilkan oleh AI.';
...
$string['privacy:metadata:local_assign_ai_queue'] = 'Mengantrekan tugas pemrosesan AI yang tertunda.';
$string['privacy:metadata:local_assign_ai_queue:payload'] = 'Muatan tugas, yang mencakup pengidentifikasi pengguna dan modul kursus dari kiriman yang akan diproses.';
