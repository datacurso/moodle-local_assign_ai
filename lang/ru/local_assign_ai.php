...
$string['defaultenableai_desc'] = 'Управляет глобальной доступностью ИИ для заданий. Если отключено, ИИ приостанавливается для всех заданий без изменения их сохранённой конфигурации; после повторного включения каждое задание продолжает работать с исходной конфигурацией.';
...
$string['error_generic'] = 'Проверка с помощью ИИ не удалась. Подробности см. в журнале истории ИИ.';
...
$string['logrubriccriterionbyid'] = 'совпадение по id ({$a})';
$string['logrubriccriterionbyname'] = 'совпадение по названию (id критерия {$a})';
$string['logrubriccriterionnotmatched'] = 'НЕ совпадает';
$string['logrubricdiagfailed'] = 'Не удалось сформировать диагностику сопоставления рубрики.';
$string['logrubricfailurereason'] = 'причина: {$a}';
$string['logrubricinvalidjson'] = 'Сохранённый JSON рубрики недействителен:';
$string['logrubricjson'] = 'JSON рубрики (ответ ИИ)';
$string['logrubriclevelbyid'] = 'id уровня {$a}';
$string['logrubriclevelbypoints'] = 'id уровня {$a} (совпадение по баллам)';
$string['logrubriclevelnotmatched'] = 'уровень НЕ совпадает';
$string['logrubricmatchfailed'] = 'Сопоставление рубрики: ОШИБКА ({$a->matched}/{$a->total})';
$string['logrubricmatchok'] = 'Сопоставление рубрики: OK ({$a->matched}/{$a->total})';
$string['logrubricmodelegacy'] = 'Режим сопоставления: устаревший (запись без id, сохранена более старой версией плагина или сервиса ИИ)';
$string['logrubricmodestrict'] = 'Режим сопоставления: строгий (запись содержит id Moodle)';
$string['logrubricnodefinition'] = 'Определение рубрики для сопоставления недоступно; отображается только сохранённый JSON.';
...
$string['privacy:metadata:datacurso_ai'] = 'Данные ответа отправляются поставщику ИИ Datacurso для формирования оценок и отзывов. Идентификаторы псевдонимизируются, когда это возможно.';
$string['privacy:metadata:datacurso_ai:course_activity'] = 'Контекст курса и задания (названия, описание и инструкции).';
$string['privacy:metadata:datacurso_ai:student_name'] = 'Полное имя студента (псевдонимизируется перед отправкой, когда это возможно).';
$string['privacy:metadata:datacurso_ai:submission_files'] = 'Файлы, прикреплённые к ответу.';
$string['privacy:metadata:datacurso_ai:submission_text'] = 'Онлайн-текст ответа.';
$string['privacy:metadata:datacurso_ai:userid'] = 'Идентификатор студента, чей ответ оценивается.';
$string['privacy:metadata:local_assign_ai_config'] = 'Хранит настройки ИИ для каждого задания.';
$string['privacy:metadata:local_assign_ai_config:assignmentid'] = 'Задание, к которому относится настройка.';
$string['privacy:metadata:local_assign_ai_config:graderid'] = 'Пользователь, указанный как оценивающий для оценок, применённых ИИ.';
$string['privacy:metadata:local_assign_ai_config:usermodified'] = 'Пользователь, последним изменивший настройку.';
...
$string['privacy:metadata:local_assign_ai_pending:assessment_guide_response'] = 'Обратная связь по руководству оценивания, созданная ИИ.';
...
$string['privacy:metadata:local_assign_ai_queue'] = 'Ставит в очередь отложенные задачи обработки ИИ.';
$string['privacy:metadata:local_assign_ai_queue:payload'] = 'Содержимое задачи, включающее идентификаторы пользователя и модуля курса обрабатываемого ответа.';
