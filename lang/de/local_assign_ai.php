...
$string['confirm_cancel_review'] = 'Diese KI-Überprüfung abbrechen? Sie kehrt in den Status „Ausstehend“ zurück, damit Sie sie erneut versuchen können.';
...
$string['defaultenableai_desc'] = 'Steuert die globale Verfügbarkeit von KI für Aufgaben. Wenn deaktiviert, wird die KI in allen Aufgaben pausiert, ohne deren gespeicherte Konfiguration zu verändern; nach dem erneuten Aktivieren arbeitet jede Aufgabe wieder mit ihrer ursprünglichen Konfiguration.';
...
$string['downloadlog'] = 'Protokoll herunterladen';
...
$string['errorparsingguide'] = 'Fehler beim Analysieren der Antwort der Bewertungsrichtlinie: {$a}';
...
$string['logerror'] = 'Fehler';
$string['logfailed'] = 'Fehlgeschlagen';
$string['logrubriccriterionbyid'] = 'Übereinstimmung per ID ({$a})';
$string['logrubriccriterionbyname'] = 'Übereinstimmung per Name (Kriterium-ID {$a})';
$string['logrubriccriterionnotmatched'] = 'KEINE Übereinstimmung';
$string['logrubricdiagfailed'] = 'Die Diagnose der Rubrik-Zuordnung konnte nicht erstellt werden.';
$string['logrubricfailurereason'] = 'Grund: {$a}';
$string['logrubricinvalidjson'] = 'Das gespeicherte Rubrik-JSON ist ungültig:';
$string['logrubricjson'] = 'Rubrik-JSON (KI-Antwort)';
$string['logrubriclevelbyid'] = 'Stufen-ID {$a}';
$string['logrubriclevelbypoints'] = 'Stufen-ID {$a} (Übereinstimmung per Punkte)';
$string['logrubriclevelnotmatched'] = 'Stufe OHNE Übereinstimmung';
$string['logrubricmatchfailed'] = 'Rubrik-Zuordnung: FEHLGESCHLAGEN ({$a->matched}/{$a->total})';
$string['logrubricmatchok'] = 'Rubrik-Zuordnung: OK ({$a->matched}/{$a->total})';
$string['logrubricmodelegacy'] = 'Zuordnungsmodus: Alt (Datensatz ohne IDs, gespeichert von einer älteren Version des Plugins oder des KI-Dienstes)';
$string['logrubricmodestrict'] = 'Zuordnungsmodus: strikt (der Datensatz enthält Moodle-IDs)';
$string['logrubricnodefinition'] = 'Es ist keine Rubrik-Definition für die Zuordnung verfügbar; es wird nur das gespeicherte JSON angezeigt.';
$string['logsuccess'] = 'Erfolgreich';
$string['manytasksreviewed'] = '{$a} Aufgaben überprüft';
$string['messageprovider:gradingfailed'] = 'Benachrichtigungen über fehlgeschlagene KI-Bewertungen';
...
$string['nopermissiontochangestatus'] = 'Sie haben keine Berechtigung, Änderungen an KI-Überprüfungen zu speichern oder zu genehmigen. Sie können nur die Details ansehen.';
...
$string['privacy:metadata:datacurso_ai'] = 'Die Abgabedaten werden zur Erstellung von Bewertungen und Feedback an den KI-Anbieter Datacurso gesendet. Kennungen werden nach Möglichkeit pseudonymisiert.';
$string['privacy:metadata:datacurso_ai:course_activity'] = 'Der Kurs- und Aufgabenkontext (Namen, Beschreibung und Anweisungen).';
$string['privacy:metadata:datacurso_ai:student_name'] = 'Der vollständige Name der/des Teilnehmenden (vor dem Senden nach Möglichkeit pseudonymisiert).';
$string['privacy:metadata:datacurso_ai:submission_files'] = 'Die an die Abgabe angehängten Dateien.';
$string['privacy:metadata:datacurso_ai:submission_text'] = 'Der Online-Text der Abgabe.';
$string['privacy:metadata:datacurso_ai:userid'] = 'Die Kennung der/des Teilnehmenden, deren/dessen Abgabe bewertet wird.';
$string['privacy:metadata:local_assign_ai_config'] = 'Speichert die KI-Konfiguration je Aufgabe.';
$string['privacy:metadata:local_assign_ai_config:assignmentid'] = 'Die Aufgabe, zu der die Konfiguration gehört.';
$string['privacy:metadata:local_assign_ai_config:graderid'] = 'Die als Bewerter/in für KI-Bewertungen erfasste Person.';
$string['privacy:metadata:local_assign_ai_config:usermodified'] = 'Die Person, die die Konfiguration zuletzt geändert hat.';
...
$string['privacy:metadata:local_assign_ai_pending:assessment_guide_response'] = 'Das von der KI generierte Feedback zur Bewertungsrichtlinie.';
$string['privacy:metadata:local_assign_ai_pending:assignmentid'] = 'Die Aufgabe, zu der dieses KI-Feedback gehört.';
$string['privacy:metadata:local_assign_ai_pending:attemptnumber'] = 'Die Nummer des Abgabeversuchs, auf den sich dieses KI-Feedback bezieht.';
$string['privacy:metadata:local_assign_ai_pending:courseid'] = 'Der Kurs, der mit diesem Feedback verknüpft ist.';
$string['privacy:metadata:local_assign_ai_pending:edited'] = 'Ob diese Bewertung eine Bearbeitung der Abgabe durch die Studierenden widerspiegelt.';
$string['privacy:metadata:local_assign_ai_pending:errormessage'] = 'Der gemeldete Fehler, wenn die KI-Verarbeitung fehlgeschlagen ist.';
...
$string['privacy:metadata:local_assign_ai_pending:submissionid'] = 'Der Abgabeversuch, für den dieses KI-Feedback erstellt wurde.';
$string['privacy:metadata:local_assign_ai_pending:submissionmodified'] = 'Der Änderungszeitpunkt der Abgabe, der bei der Erstellung dieses KI-Feedbacks erfasst wurde.';
...
$string['privacy:metadata:local_assign_ai_queue'] = 'Stellt verzögerte KI-Verarbeitungsaufgaben in die Warteschlange.';
$string['privacy:metadata:local_assign_ai_queue:payload'] = 'Die Aufgabendaten, einschließlich der Benutzer- und Kursmodulkennungen der zu verarbeitenden Abgabe.';
...
$string['retryallfailed'] = 'Fehlgeschlagene erneut versuchen';
$string['retryallqueued'] = '{$a} fehlgeschlagene Überprüfung(en) erneut in die Warteschlange gestellt.';
$string['retryqueued'] = 'Überprüfung erneut in die Warteschlange gestellt; sie wird in Kürze verarbeitet.';
$string['review'] = 'Überprüfen';
$string['reviewaidisabled'] = 'Die KI-Überprüfung ist für diese Aufgabe deaktiviert.';
$string['reviewall'] = 'Alle überprüfen';
$string['reviewcancelled'] = 'KI-Überprüfung abgebrochen.';
$string['reviewhistory'] = 'Verlauf der KI-Überprüfung';
$string['reviewnotsubmitted'] = 'Der Abgabeversuch befindet sich nicht im Status „Eingereicht“ und kann daher nicht von der KI überprüft werden.';
...
$string['statussuperseded'] = 'Ersetzt (vorheriger Versuch)';
...
$string['superseded'] = 'Ersetzt';
$string['task_process_ai_queue'] = 'Verzögerte Warteschlange von Assign AI verarbeiten';
$string['task_reap_stuck'] = 'Hängengebliebene KI-Einreichungen bereinigen';
$string['task_retry_failed'] = 'Fehlgeschlagene KI-Einreichungen erneut versuchen';
